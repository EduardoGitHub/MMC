...
// if the customer is not logged on, redirect them to the login page
  ...
  $product_check_query = tep_db_query("select count(*) as total, products_image from " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION . " pd where p.products_status = '1' and p.products_id = '" . (int)$HTTP_GET_VARS['products_id'] . "' and pd.products_id = p.products_id and pd.language_id = '" . (int)$languages_id . "'");
...
?>
<link rel="image_src" href="<?=HTTP_SERVER.'/'.DIR_WS_IMAGES_PRODUTOS.$product_check['products_image']?>" />
...
.Produtos{ border:1px dotted #CCC; padding:5px; }
...
.optionTamanho .info b{color:#A48C34}
...
<div id="container" style="border:0">
  ...
  <div class="Produtos">
   ...
   <?php echo tep_draw_form('cart_quantity', tep_href_link(FILENAME_PRODUCT_INFO, tep_get_all_get_params(array('action')) . 'action=add_product'),'post', 'onsubmit="return checkform(this);"');?>  
    ...
    <div>
            ...
            <div class="CaminhoNav"><? echo '<a href="'.tep_href_link(FILENAME_DEFAULT).'">Home</a> / '.$breadcrumb->trail(' / '); ?></div>
    ...
    <div style="width:970px; float:left; margin:20px 0 0 0">
    	<div style="float:left; margin:10px;"><? echo tep_display_option($HTTP_GET_VARS['products_id'], '1', $languages_id, false, $preco); //Atributos tamanho?></div>
        <div style="float:left"><?=tep_display_option($HTTP_GET_VARS['products_id'], '2', $languages_id);//Atributos cor ?></div>   
        <div style="float:left; margin:50px 0 0 30px; text-align:center"><?=tep_display_option($HTTP_GET_VARS['products_id'], '3', $languages_id);//Atributos espelhado ?></div> 
    	<div style="clear:both"></div>
    </div>
    ...
    <div style="width:970px; float:left; margin:20px 0 0 0">
        ...
        <div class="botoesProdutos">
        	<ul>
            	<li style="background-color:#D7AB00"><a href="<?=tep_href_link(FILENAME_INFORMATION, 'cod=1')?>">Como Comprar</a></li>
                <li style="background-color:#D7AB00"><a href="<?=tep_href_link('como-aplicar.php')?>">Como Aplicar</a></li>
                <li style="background-color:#D7AB00"><a href="<?=tep_href_link(FILENAME_INFORMATION, 'cod=6')?>">Prazo de entrega</a></li>
        ...
        <div style="font-family:Tahoma; font-weight:bold; padding:10px"><span style="color:#D7AB00">//////////////////////////////////////</span>&nbsp;&nbsp;Formas de Pagamento&nbsp;&nbsp;<span style="color:#D7AB00">\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\</span></div>
                ...
                <div style="padding:10px 0 10px; font-family:Tahoma; "><span style="color:#A28D34; font-weight:bold">10%</span> de desconto para depósito, transferência Bank Line ou boleto</div>
        </div>      
        
        <div class="DescricaoProduto">
        	<div style="font-family:Tahoma; font-weight:bold; padding:10px; text-align:center; font-size:16px;"><span style="color:#D7AB00">/////////////////////////////////////</span>&nbsp;&nbsp;Informações do Produto&nbsp;&nbsp;<span style="color:#D7AB00">\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\</span></div>
        	<br />
