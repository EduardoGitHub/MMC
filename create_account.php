...
*/
  ...
  if (isset($HTTP_POST_VARS['action']) && ($HTTP_POST_VARS['action'] == 'process')) {
    ...
    if ((ACCOUNT_DOB == 'true')&&($_POST['c']=='F')) $dob = tep_db_prepare_input($HTTP_POST_VARS['dob']);
    $email_address = tep_db_prepare_input($HTTP_POST_VARS['email_address']);
	$email_address_confirmation = tep_db_prepare_input($HTTP_POST_VARS['email_address_confirmation']);
    if ((ACCOUNT_COMPANY == 'true')||($_POST['c']=='J')) $company = tep_db_prepare_input($HTTP_POST_VARS['company']);
    $street_address = tep_db_prepare_input($HTTP_POST_VARS['street_address']);
	$street_number = tep_db_prepare_input($HTTP_POST_VARS['street_number']);
	$cpf = tep_db_prepare_input($HTTP_POST_VARS['cpf']);
	$rg = tep_db_prepare_input($HTTP_POST_VARS['rg']);
	$revenda = tep_db_prepare_input($HTTP_POST_VARS['revenda']);
    if (ACCOUNT_SUBURB == 'true') $suburb = tep_db_prepare_input($HTTP_POST_VARS['suburb']);
	

	if (ACCOUNT_PARTNER == 'true') $partner = tep_db_prepare_input($HTTP_POST_VARS['customers_partner']);
	
	$complemento = tep_db_prepare_input($HTTP_POST_VARS['complemento']);
	...
	$telephone_comercial = tep_db_prepare_input($HTTP_POST_VARS['telephone_comercial']);
	$telephone_celular = tep_db_prepare_input($HTTP_POST_VARS['telephone_celular']);
