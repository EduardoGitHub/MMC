...
*/
  ...
  if (isset($HTTP_GET_VARS['action']) && ($HTTP_GET_VARS['action'] == 'process')) {
	...
	$telphone = tep_db_prepare_input($HTTP_POST_VARS['telphone']);
    ...
    if ($error == false) {
	  ...
	  $html =  sprintf(TEXT_EMAIL_INTRO, STORE_OWNER, $from_name, $product_info['products_name'], $from_email_address, $telphone,$product_info['products_name']).
				...
				sprintf(TEXT_EMAIL_LINK, tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $HTTP_GET_VARS['products_id'])).'<br/><br/> '.
  ...
  $breadcrumb->add(NAVBAR_TITLE, tep_href_link(FILENAME_NOTIFYME_PRODUCT, 'products_id=' . $HTTP_GET_VARS['products_id']));
?>
...
<div id="container">
  ...
  <div id="mainContent">
      ...
      <?php echo tep_draw_form('email_friend', tep_href_link(FILENAME_NOTIFYME_PRODUCT, 'action=process&products_id=' . $HTTP_GET_VARS['products_id'])); ?>
        <div class="pagestexto">
            ...
            <div><?php echo '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $HTTP_GET_VARS['products_id']) . '">' . tep_image_button('button_back.gif', IMAGE_BUTTON_BACK) . '</a>'; ?>
