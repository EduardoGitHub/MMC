  ...
  if (isset($HTTP_GET_VARS['action']) && ($HTTP_GET_VARS['action'] == 'send')) {
 	...
 	//if($customer_id > 0){
		...
		define('EMAIL_SUBJECT', ' :: ORÇAMENTO :: ' . STORE_NAME);
			...
			$nomeCod_op1 = tep_db_prepare_input($HTTP_POST_VARS['nomeCodop1']);
			$tamanhoLar_op1 = tep_db_prepare_input($HTTP_POST_VARS['tamanhoLarop1']);
			$tamanhoAlt_op1 = tep_db_prepare_input($HTTP_POST_VARS['tamanhoAltop1']);
			$enquiry_op1 = tep_db_prepare_input($HTTP_POST_VARS['enquiryop1']);
