	  ...
	  /*** Begin Header Tags SEO ***/
        ...
        if (isset($HTTP_POST_VARS['products_id']) && isset($HTTP_POST_VARS['categories_id'])) {
          ...
          if ($HTTP_POST_VARS['copy_as'] == 'link') {
            ...
            $product_query = tep_db_query("select products_quantity, products_model, products_youtube, products_pack_length, products_pack_width, products_pack_height, products_pack_diameter, products_image, products_price, products_price_revenda, products_qty_blocks, products_date_available, products_weight, products_warranty, products_tax_class_id, manufacturers_id from " . TABLE_PRODUCTS . " where products_id = '" . (int)$products_id . "'");
            $product = tep_db_fetch_array($product_query);

            tep_db_query("insert into " . TABLE_PRODUCTS . " (products_quantity, products_model,products_youtube, products_pack_length, products_pack_width, products_pack_height, products_pack_diameter, products_image, products_price, products_price_revenda, products_qty_blocks, products_date_added, products_date_available, products_weight, products_warranty, products_status, products_free_shipping, products_highlight, products_tax_class_id, manufacturers_id) values ('" . tep_db_input($product['products_quantity']) . "', '" . tep_db_input($product['products_model']) . "','" . tep_db_input($product['products_youtube']) . "','" . tep_db_input($product['products_pack_length']) . "', '" . tep_db_input($product['products_pack_width']) . "', '" . tep_db_input($product['products_pack_height']) . "', '" . tep_db_input($product['products_pack_diameter']) . "', '" . tep_db_input($product['products_image']) . "', '" . tep_db_input($product['products_price']) . "', '" . tep_db_input($product['products_price_revenda']) . "', '" . tep_db_input($product['products_qty_blocks']) . "',  now(), '" . tep_db_input($product['products_date_available']) . "', '" . tep_db_input($product['products_weight']) . "','" . tep_db_input($product['products_warranty']) . "', '0', '" . (int)$product['products_tax_class_id'] . "', '" . (int)$product['manufacturers_id'] . "')");
...
<?php
    ...
    $products_count = 0;
    if (isset($HTTP_GET_VARS['search'])) {
      $products_query = tep_db_query("select p.products_id, pd.products_name, p.products_quantity, p.products_image, p.products_price, p.products_price_revenda, p.products_qty_blocks, p.products_date_added, p.products_last_modified, p.products_date_available, p.products_status, p.products_free_shipping, p.products_highlight, p2c.categories_id from " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION . " pd, " . TABLE_PRODUCTS_TO_CATEGORIES . " p2c where p.products_id = pd.products_id and pd.language_id = '" . (int)$languages_id . "' and p.products_id = p2c.products_id and pd.products_name like '%" . tep_db_input($search) . "%' order by pd.products_name");
    }elseif(isset($HTTP_GET_VARS['fab'])) {
	/*echo "<script>alert ('entrou')</script>";*/
	 $products_query = tep_db_query("select p.products_id, pd.products_name, p.products_quantity, p.products_image, p.products_price, p.products_price_revenda, p.products_qty_blocks, p.products_date_added, p.products_last_modified, p.products_date_available, p.products_status, p.products_free_shipping, p.products_highlight from " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION . " pd, " . TABLE_PRODUCTS_TO_CATEGORIES . " p2c where p.products_id = pd.products_id and pd.language_id = '" . (int)$languages_id . "' and p.products_id = p2c.products_id and p.manufacturers_id = '" . $HTTP_GET_VARS['fab'] . "' order by pd.products_name");
	...
	/* echo "select p.products_id, pd.products_name, p.products_quantity, p.products_image, p.products_price, p.products_price_revenda, p.products_qty_blocks, p.products_date_added, p.products_last_modified, p.products_date_available, p.products_status, p.products_free_shipping from " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION . " pd, " . TABLE_PRODUCTS_TO_CATEGORIES . " p2c where p.products_id = pd.products_id and pd.language_id = '" . (int)$languages_id . "' and p.products_id = p2c.products_id and p.products_id = '" . $HTTP_GET_VARS['fab'] . "' order by pd.products_name";*/
      ...
      $products_query = tep_db_query("select p.products_id, pd.products_name, p.products_quantity, p.products_image, p.products_price, p.products_price_revenda, p.products_qty_blocks, p.products_date_added, p.products_last_modified, p.products_date_available, p.products_status, p.products_free_shipping, p.products_highlight from " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION . " pd, " . TABLE_PRODUCTS_TO_CATEGORIES . " p2c where p.products_id = pd.products_id and pd.language_id = '" . (int)$languages_id . "' and p.products_id = p2c.products_id and p2c.categories_id = '" . (int)$current_category_id . "' order by pd.products_name");
    }
