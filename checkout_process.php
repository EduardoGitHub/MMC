 ...
 /*
  ...
  $email_order .= "\n" . EMAIL_TEXT_BILLING_ADDRESS . "\n" .
    ...
    $comments .= tep_db_output($order->info['comments']) . "<br/>";
		...
		if ($order->content_type != 'virtual') {
    $email_order3 .= tep_address_label($customer_id, $sendto, 0, '', "<br/>") . "<br/>";
  }
...
$html = '
<table width="760" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #CCC; padding:15px; background-color:#D7AB00">
  <tr>
    <td>
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="56%" style="font-size:30px;">'.EMAIL_TEXT_ORDER_NUMBER.'</b> '.$insert_id.'</td>
                  ...
                  <tr>
                    ...
                    <td width="50%" align="right">
                    	<table width="95%" border="0" cellspacing="0" cellpadding="0" style="font-family:Calibri">
                          ...
                          <tr>
                            <td style="font-size:15px; color:#000; vertical-align:bottom; padding-top:10px;padding-bottom:10px; padding-left:10PX; line-height:20px; text-align:left; background-color:#D9E5FF">'.tep_address_label($customer_id, $billto, 0, '', "<br/>") . '"<br/><br/></td>
                          </tr>
                        </table>
                    </td>
                  </tr>
