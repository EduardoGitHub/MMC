<?php
  ...
  if (isset($HTTP_GET_VARS['action']) && ($HTTP_GET_VARS['action'] == 'send')) {
 	...
 	//if($customer_id > 0){
		...
		$nome = tep_db_prepare_input($HTTP_POST_VARS['nome']);
		...
		$information1op6 = tep_db_prepare_input($HTTP_POST_VARS['information1op6']);
		$information2op6 = tep_db_prepare_input($HTTP_POST_VARS['information2op6']);
		$ideiaop6 = tep_db_prepare_input($HTTP_POST_VARS['ideiaop6']);
		$estilop = tep_db_prepare_input($HTTP_POST_VARS['estilop']);

		
		//$corop6 = tep_db_prepare_input($HTTP_POST_VARS['corop6']);
		$enquiryop6 = tep_db_prepare_input($HTTP_POST_VARS['enquiryop6']);
		...
		if (tep_validate_email($email)) {
		  ...
		  tep_redirect(tep_href_link('envie-seus-arquivos.php', 'nome='.$nome.'&email='.$email.'&telefone='.$telefone.'&cep='.$cep.'&url=produtos-personalizados.php'));
		} else {
		  $error = true;
...
<div id="container">
  ...
  <div id="mainContent">
      ...
      <?php echo tep_draw_form('produtos-personalizados', tep_href_link('produtos-personalizados.php', 'action=send'), 'post', 'enctype="multipart/form-data"'); ?>
