...
define('NAVBAR_TITLE', 'Frete e Devoluções');
define('HEADING_TITLE', 'Frete e Devoluções');

define('TEXT_INFORMATION', 'Coloque aqui as informações de Frete e Devoluções.');
?>
