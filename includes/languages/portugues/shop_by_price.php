<?php
define('NAVBAR_TITLE', 'Compre pelo Preço');
define('HEADING_TITLE', 'Compre pelo Preço');
...
define('TABLE_HEADING_WEIGHT', 'Pesp');
define('TABLE_HEADING_MULTIPLE', 'Qty: ');	// To be translated
