...
// +--------------------------------------------------------------------------------------+
  ...
  define('MODULE_PAYMENT_BOLETOBRADESCO_TEXT_TITLE', 'Boleto Bancário Banco do Bradesco');
  define('MODULE_PAYMENT_BOLETOBRADESCO_TEXT_DESCRIPTION', 'Geração de Boleto Bancário Bradesco<br>');
?>
