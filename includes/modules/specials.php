	...
	case 5:
	  ...
	  <li style="width:'.$widthli.';">
		<div style="max-width:380px; margin:0 auto;">
			...
			<div style="width:'.SMALL_IMAGE_WIDTH.'px; height:'.SMALL_IMAGE_HEIGHT.'px;"><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $specials['products_id']) . '">' . tep_image_produto(DIR_WS_IMAGES_PRODUTOS . $specials['products_image'], $specials['products_name'], 'YES', 'P') . '</a></div><br/>
			
			<a class="pr_name"  href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $specials['products_id']) . '">' . $specials['products_name'] . '</a><br/>';
