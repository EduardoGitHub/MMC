  ...
  /**
    ...
    **/
    ...
    protected function configuraCobreDireto(){
      ...
      $this->visa_credito = CD_VISA_CREDITO;	  
      $this->master_credito = CD_MASTER_CREDITO;	  
      $this->diner_credito = CD_DINER_CREDITO;	  
      $this->amex_credito = CD_AMEX_CREDITO;	  
      $this->bradesco_debito = CD_BRADESCO_DEBITO;	  
      $this->itau_debito = CD_ITAU_DEBITO;	  
      $this->banco_brasil_debito = CD_BRANCO_BRASIL_DEBITO;	  
      $this->unibanco_debito = CD_UNIBANCO_DEBITO;	  
      $this->real_debito = CD_REAL_DEBITO;	  
      $this->banrisul_debito = CD_BANRISUL_DEBITO;	
      $this->bradesco_boleto = CD_BRADESCO_BOLETO;	  
      $this->itau_boleto = CD_ITAU_BOLETO;	  
      $this->branco_brasil_boleto = CD_BANCO_BRASIL_BOLETO;	  
      $this->unibanco_boleto = CD_UNIBANCO_BOLETO;	  
      $this->real_boleto = CD_REAL_BOLETO;	  
    ...
    public function __call($method, $argument){
      $liberados = array('codpedido','url_recibo','url_retorno','url_erro','usuario','senha','codloja','ambiente','frete' , 'visa_credito',
      'visa_credito' , 'master_credito' , 'diner_credito' , 'amex_credito' , 'bradesco_debito' , 'itau_debito' , 'banco_brasil_debito' , 
      'unibanco_debito' , 'real_debito' , 'banrisul_debito' , 'bradesco_boleto' , 'itau_boleto' , 'branco_brasil_boleto' , 'unibanco_boleto' , 
      'real_boleto');
