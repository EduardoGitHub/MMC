...
// * DIR_WS_* = Webserver directories (virtual/URL)
  define('HTTP_URL_EMAIL_ORDER', 'http://www.mudo.com.br');
  define('HTTPS_URL_EMAIL_ORDER', 'https://www.mudo.com.br');
  define('HTTP_SERVER_PRODUTOS', 'images/ImgProdutos/');
  define('HTTP_SERVER_IMAGES', ' images/');
  define('HTTP_SERVER', 'http://www.mudo.com.br'); // eg, http://localhost - should not be empty for productive servers
  define('HTTPS_SERVER', 'https://www.mudo.com.br'); // eg, https://localhost - should not be empty for productive servers
  define('ENABLE_SSL', false); // secure webserver for checkout procedure?
  define('HTTP_COOKIE_DOMAIN', 'www.mudo.com.br');
  define('HTTPS_COOKIE_DOMAIN', 'www.mudo.com.br');
