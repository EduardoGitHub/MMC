<?php
  ...
  if (isset($HTTP_GET_VARS['action']) && ($HTTP_GET_VARS['action'] == 'send')) {
  	$error = false;
		...
		$tamanhoLarop8 = tep_db_prepare_input($HTTP_POST_VARS['tamanhoLarop8']);
		$tamanhoAltop8 = tep_db_prepare_input($HTTP_POST_VARS['tamanhoAltop8']);
		$enquiryop8 = nl2br($HTTP_POST_VARS['enquiryop8']);
		...
		if (tep_validate_email($email)) {
		  ...
		  tep_redirect(tep_href_link('envie-seus-arquivos.php', 'nome='.$nome.'&email='.$email.'&telefone='.$telefone.'&cep='.$cep.'&url=envie-seu-modelo.php'));
		} else {
		  $error = true;
...
<div id="container">
  ...
  <div id="mainContent">
      ...
      <?php echo tep_draw_form('envie-seu-modelo', tep_href_link('envie-seu-modelo.php', 'action=send'), 'post', 'enctype="multipart/form-data"'); ?>
